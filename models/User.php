...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['username', 'auth_key', 'password_hash', 'email', 'rol_id'], 'required'],
            ...
            [['rol_id'], 'exist', 'skipOnError' => true, 'targetClass' => Rol::className(), 'targetAttribute' => ['rol_id' => 'idRol']],
        ];
    }
    ...
    public static function getRolUser($id=null){
        if($id)
            return Rol::find()->select('nombre')->where(['idRol'=>$id])->orderBy('id')->one();
        else
            return Rol::find()->orderBy('idRol')->all();
    }

    public static function toList() {
      $model = User::getRolUser();
